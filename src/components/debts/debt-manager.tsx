...
const mockDebtAccounts: DebtAccount[] = [
  ...
  { id: "debt3", name: "Car Loan - Local CU", type: "auto-loan", balance: 8700.50, apr: 4.2, minimumPayment: 350, paymentDayOfMonth: 10, paymentFrequency: "bi-weekly", userId: "1", createdAt: new Date() },
];
